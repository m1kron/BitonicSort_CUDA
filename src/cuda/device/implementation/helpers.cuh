...
__device__ bool PerformSwapIfNeeded(int& val1, int& val2,
...
////////////////////////////////////////////////////////////////////////////
__device__ __forceinline__ bool PerformSwapIfNeeded(int& val1, int& val2,
                                                    const bool increasing) {
  const bool swapNeeded = increasing ? NeedsToBeSwapped<int, true>(val1, val2)
                                     : NeedsToBeSwapped<int, false>(val1, val2);

  if (swapNeeded) helpers::Swap(val1, val2);
